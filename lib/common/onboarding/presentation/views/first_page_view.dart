      ...
      Column(
        ...
        children: [
            SizedBox(height: 30),
              ...
              Expanded(child: 
              Image.asset("assets/images/Health professional team-amico 1 (1).png")
              ),

              Align(
               // alignment: Alignment.centerRight,
               alignment: AlignmentGeometry.directional(0.5, 0),
                child: _buildText("اختر الخدمه التي\nتحتاجها")),

                 Align(
                alignment: Alignment.center,
                child: Text(
                  
                  "اختر نوع الرعايه الصحيه التي تبحث عنها\nدكتور , ممرض , علاج طبيعي , و غيرها",
